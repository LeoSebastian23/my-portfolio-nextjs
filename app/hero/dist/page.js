...
var Hero = function () {
    return (react_1["default"].createElement("div", { className: "flex flex-col items-center justify-around min-h-screen p-8 text-left" },
        react_1["default"].createElement("div", null,
            react_1["default"].createElement("h1", { className: "text-8xl mb-4" }, "Leonardo Sebastian"),
            react_1["default"].createElement("h2", { className: "text-3xl mb-4" }, "Desarrollador Full Stack."),
